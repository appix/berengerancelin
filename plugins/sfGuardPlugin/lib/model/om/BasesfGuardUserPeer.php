...
abstract class BasesfGuardUserPeer {
	...
	{
		// Invalidate objects in ProfilPeer instance pool,
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related Profil objects
			$criteria = new Criteria(ProfilPeer::DATABASE_NAME);
			
			$criteria->add(ProfilPeer::USER_ID, $obj->getId());
			$affectedRows += ProfilPeer::doDelete($criteria, $con);
