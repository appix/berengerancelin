...
abstract class BasePagePeer {
	...
	const MENU_INDEX = 'page.MENU_INDEX';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Slug', 'MenuIndex', 'Content', 'Language', 'Published', 'Homepage', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'slug', 'menuIndex', 'content', 'language', 'published', 'homepage', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::SLUG, self::MENU_INDEX, self::CONTENT, self::LANGUAGE, self::PUBLISHED, self::HOMEPAGE, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'SLUG', 'MENU_INDEX', 'CONTENT', 'LANGUAGE', 'PUBLISHED', 'HOMEPAGE', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'slug', 'menu_index', 'content', 'language', 'published', 'homepage', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Slug' => 2, 'MenuIndex' => 3, 'Content' => 4, 'Language' => 5, 'Published' => 6, 'Homepage' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'slug' => 2, 'menuIndex' => 3, 'content' => 4, 'language' => 5, 'published' => 6, 'homepage' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::SLUG => 2, self::MENU_INDEX => 3, self::CONTENT => 4, self::LANGUAGE => 5, self::PUBLISHED => 6, self::HOMEPAGE => 7, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'SLUG' => 2, 'MENU_INDEX' => 3, 'CONTENT' => 4, 'LANGUAGE' => 5, 'PUBLISHED' => 6, 'HOMEPAGE' => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'slug' => 2, 'menu_index' => 3, 'content' => 4, 'language' => 5, 'published' => 6, 'homepage' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(PagePeer::MENU_INDEX);
			$criteria->addSelectColumn(PagePeer::CONTENT);
			$criteria->addSelectColumn(PagePeer::LANGUAGE);
			$criteria->addSelectColumn(PagePeer::PUBLISHED);
			$criteria->addSelectColumn(PagePeer::HOMEPAGE);
		} else {
			$criteria->addSelectColumn($alias . '.ID');
			$criteria->addSelectColumn($alias . '.NAME');
			$criteria->addSelectColumn($alias . '.SLUG');
			$criteria->addSelectColumn($alias . '.MENU_INDEX');
